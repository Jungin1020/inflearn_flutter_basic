...
abstract class $PhotoCopyWith<$Res> {
  ...
  @useResult
  $Res call({num id, num views, String url});
}
...
class _$_Photo with DiagnosticableTreeMixin implements _Photo {
  const _$_Photo({required this.id, required this.views, required this.url});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Photo(id: $id, views: $views, url: $url)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, views, url);
...
abstract class _Photo implements Photo {
  const factory _Photo(
      ...
      required final String url}) = _$_Photo;
